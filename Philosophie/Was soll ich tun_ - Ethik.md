...
|Beide machen eine Naturzustandsüberlegung<br><br>Eine Natur des Menschen ist festellbar<br><br>Vorstellung über einen Naturzustand<br><br>instinktgeprägt, kein Fortschritt||
...
V![](file:///tmp/lu193345p5pr.tmp/lu193345p5s8_tmp_cdcf83c1.png) ergleiche Gemeinsamkeiten und Unterschiede
...
![](file:///tmp/lu193345p5pr.tmp/lu193345p5s8_tmp_dc689879.png)  
...
```mermaid
graph TD;
    A[Moral] -- Bildet sich aus --> B[Ethik];
    D[Werte] -- Beeinflussen --> A;
    E[Normen] -- Sind Teil von --> A;
    F[Kultur] -- Umfasst --> E;
    F -- Umfasst --> D;
```
...
graph TD;
    A[Seele] --> B[irational];
    B --> C[Vegetatives Vermögen];
    B --> D[strebendes Vermögen];
    D --> G[Affekte];
    A --> E[rational];
    E --> F[national Wirkendendes Vermögen];
    F -- beeinflusst --> G;
